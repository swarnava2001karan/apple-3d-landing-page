...
const ProcessorSection = () => {
  return (
    <Section>
      ...
      <Text>
        <span>
        Apple's iPhone has revolutionized the smartphone industry, offering a sleek and intuitive design with a multi-touch display that made navigating through apps and websites seamless. 
        </span>
        <span>
        </span>
      </Text>
